defmodule MoyaSqueezer.MetricsApiTest do
  ...
  describe "worker_payload/0" do
    test "includes windowed outbound metrics" do
  ...
  describe "manager_payload/0" do
    test "includes cached total and per-worker dispatch" do
      segments = [
